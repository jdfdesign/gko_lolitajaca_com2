...
# server details
set :deploy_dir, "/home/#{user}/ror/lolitajaca2_com" #deploy directory
...
set :repository,  "git@github.com:jdfdesign/gko_lolitajaca_com2.git" #Github repository
...
namespace :deploy do
  ...
  task :update_symlinks, :except => { :no_release => true }, :roles => :app do 
    ...
    run "rm -rf /home/#{user}/public_html/lolitajaca2"
    run "ln -nsf #{release_path}/public /home/#{user}/public_html/lolitajaca2"
